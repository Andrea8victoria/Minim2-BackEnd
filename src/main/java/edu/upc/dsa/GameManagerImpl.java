...
public class GameManagerImpl implements GameManager {
    ...
    protected List<Question> consultas;
 ...
 */
    ...
    public int realizarConsulta(String date, String title, String message, String sender) {
        Question p = new Question(date, title, message, sender);
